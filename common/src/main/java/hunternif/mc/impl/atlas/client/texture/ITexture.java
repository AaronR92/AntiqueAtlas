...
public interface ITexture {
    ...
    void draw(MatrixStack context, int x, int y);

    void draw(MatrixStack context, int x, int y, int width, int height);

    void drawCenteredWithRotation(MatrixStack context, int x, int y, int width, int height, float rotation);

    void draw(MatrixStack context, int x, int y, int width, int height, int u, int v, int regionWidth, int regionHeight);

    void draw(MatrixStack context, int x, int y, int u, int v, int regionWidth, int regionHeight);
